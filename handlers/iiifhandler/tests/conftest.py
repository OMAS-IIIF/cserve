...
class CserverProcessManager:
    ...
    def __init__(self, cserver_exe, cserver_handlerdir):
        ...
        self.cserver_config = {
            ...
            "IIIFHANDLER_IMGROOT": "./iiiftestserver/imgroot",
    ...
    def download_file(self, iiifpath, suffix=None, headers=None):
        response = requests.get(iiifpath, headers=headers, stream=True)
    ...
    def compare_erver_images(self, iiifurl, expected_file_path, headers=None):
        pass
